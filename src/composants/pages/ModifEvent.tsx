            ...
            <div className="body-coach-creation-events">
                <div className="body-creation-event-coach">
                    <div className="title-creation-event">
                        Modification de l'événement <span>&nbsp;</span><i>{eventData?.name}</i>
                    </div>
                            ...
                            <div className="formulaire-event-classique">
                                ...
                                <div className="form-left">
                                    <div className="form-group">
                                        ...
                                        <input
                                            className="content-string-add-event" type="text"
                            ...
                            <div className="formulaire-big-event">
                                <div className="form-left">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setEventData({ ...eventData!, cagnotte: e.target.value })}
                                        />
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        >
                                            <option value="" disabled>Choisis un Organisateur</option>
                                ...
                                <div className="form-right">
                                    ...
                                    <div className="form-group" style={{ marginTop: '16px' }}>
                                        <button className="btn-submit-event">Confirmer la Modification</button>
                                    </div>
                                </div>
                            </div>
                        )}
                ...
                <div className="body-creation-event-coach">
                    <div className="title-creation-event">Émargement des participants</div>
