    ...
    <footer className="footer-vamd">
        <div className="footer-content-row">
            <div className="footer-section footer-catalogue">
                <h3>Catalogue</h3>
                <a href="/produits" className="footer-link">Produits</a>
                <a href="/calendrier" className="footer-link">Calendrier</a>
            </div>
            ...
            <div className="footer-section footer-contacts">
                ...
                <a href="mailto:contact@vamd.com" className="footer-link">Mail</a>
            </div>
        </div>
